USE `db_lgehrt` ;
DROP TABLE IF EXISTS `db_lgehrt`.`COMMENT`;
DROP TABLE IF EXISTS `db_lgehrt`.`RATING`;
DROP TABLE IF EXISTS `db_lgehrt`.`RESEARCH_PUBLICATION`;
DROP TABLE IF EXISTS `db_lgehrt`.`LETTER_OF_REC`;
DROP TABLE IF EXISTS `db_lgehrt`.`APPLICATION`;
DROP TABLE IF EXISTS `db_lgehrt`.`JOB_LISTING`;
DROP TABLE IF EXISTS `db_lgehrt`.`UI_PERSON_LOOKUP`;
DROP TABLE IF EXISTS `db_lgehrt`.`UI_PERSON`;
DROP TABLE IF EXISTS `db_lgehrt`.`NON_UI_PERSON_LOOKUP`;
DROP TABLE IF EXISTS `db_lgehrt`.`NON_UI_PERSON`;
DROP TABLE IF EXISTS `db_lgehrt`.`PERMISSIONS`;

-- ----------------------------------------------------- 
-- Table `db_lgehrt`.`PERMISSIONS` 
-- ----------------------------------------------------- 
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`PERMISSIONS` (  
`PERMISSION` VARCHAR(1) NOT NULL ,
`DESCRIPTION` VARCHAR(25) NOT NULL,  
PRIMARY KEY (`PERMISSION`) ) 
ENGINE = InnoDB; 
-- ----------------------------------------------------- 
-- Table `db_lgehrt`.`UI_PERSON` 
-- ----------------------------------------------------- 
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`UI_PERSON` ( 
...
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `db_lgehrt`.`NON_UI_PERSON`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`NON_UI_PERSON` (  
`ID` INT NOT NULL AUTO_INCREMENT ,  
...
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `db_lgehrt`.`JOB_LISTING`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`JOB_LISTING` (  
...
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `db_lgehrt`.`APPLICATION`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`APPLICATION` ( 
...
REFERENCES `db_lgehrt`.`JOB_LISTING` (`LISTING_ID` )    
ON DELETE NO ACTION    
ON UPDATE NO ACTION,  
CONSTRAINT `fk_application_non_UI_Person1`    
FOREIGN KEY (`NON_UI_PERSON_ID` )    
REFERENCES `db_lgehrt`.`NON_UI_PERSON` (`ID` )    
ON DELETE NO ACTION    
ON UPDATE NO ACTION) 
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `db_lgehrt`.`LETTER_OF_REC`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`LETTER_OF_REC` (  
...
REFERENCES `db_lgehrt`.`APPLICATION` (`APP_ID` )    
ON DELETE NO ACTION    
ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `db_lgehrt`.`RATING`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`RATING` (  
`RATING` INT NOT NULL ,  
...
REFERENCES `db_lgehrt`.`UI_PERSON` (`ID` )    
ON DELETE NO ACTION    
ON UPDATE NO ACTION,  
...
ENGINE = InnoDB; 
-- -----------------------------------------------------
-- Table `db_lgehrt`.`COMMENT`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`COMMENT` (  
...
REFERENCES `db_lgehrt`.`RATING` (`RATING_ID` )    
ON DELETE NO ACTION    
ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `db_lgehrt`.`UI_PERSON_LOOKUP`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`UI_PERSON_LOOKUP` (  
...
REFERENCES `db_lgehrt`.`PERMISSIONS` (`PERMISSION` )    
ON DELETE NO ACTION    
ON UPDATE NO ACTION,  
...
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `db_lgehrt`.`NON_UI_PERSON_LOOKUP`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_lgehrt`.`NON_UI_PERSON_LOOKUP` (  
`PERMISSIONS_PERMISSION` VARCHAR(1) NOT NULL ,  
`NON_UI_PERSON_ID` INT NOT NULL ,  
...
ENGINE = InnoDB;
-- ------------------------------------------------------
-- Table `db_lgehrt`.`RESEARCH_PUBLICATION`
-- ------------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_lgehrt`.`RESEARCH_PUBLICATION` (
